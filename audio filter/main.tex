...
\lstinputlisting{./codes/audio-filter2.py}\label{py:audio_filtering_code}
...
\begin{lstlisting}
https://github.com/venkatesh11010/Audio-filtering-11010/blob/main/audio%20filter/codes/h(n)def.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/h(n)def.png}
...
%
\begin{lstlisting}
https://github.com/venkatesh11010/Audio-filtering-11010/blob/main/audio%20filter/codes/y(n)byconv.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
\begin{lstlisting}
https://github.com/venkatesh11010/Audio-filtering-11010/blob/main/audio%20filter/codes/y(n)_verify.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/yn_verify.png}
...
\solution The code in \ref{py:audio_filtering_code} generates the values of $a$ and $b$  which can be used to generate a difference equation.\\
And,
\begin{align}
a &= \begin{bmatrix}
...
\begin{multline}
    H(z) = 0.005 + 0.028 z^{-1} + \\
    0.068 z^{-2} + 0.112z^{-3} \cdots\cdots
\end{multline}
\begin{multline}
    h(n) = 0.005\delta(n) + 0.028 \delta(n-1) + \\
    0.068 \delta(n-2) + 0.112\delta(n-3) \cdots\cdots
\end{multline}
Pole Zero plot:
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{figs/pole_zero_ex.png}
    \caption{$pole zero plot$}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{figs/hn_custom.png}
    \caption{$h(n)$}
\end{figure}
...
\textbf{Computing y(n) by convolution:}\\
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{figs/ex_yofn_conv.png}
    \caption{$y(n)$}
\end{figure}

\textbf{Computing y(n) by DFT and FFT:}\\
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\columnwidth]{figs/yn_by_dft_ex.png}
    \caption{$y(n)$}
\end{figure}
...
\\
\solution The given butterworth filter is lowpass with order = $3$ and cutoff-frequency = $3kHz$.
\item
